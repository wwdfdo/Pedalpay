  ...
  return (
    <div className="flex flex-col md:flex-row md:w-4/5 mx-auto gap-16 justify-between items-center">
      <div className=" w-5/6 md:w-2/5 text-white  flex flex-col gap-12 mt-36 ">
        <div>
          <h1 className=" text-[3.5rem] font-bold font-rubik text-titlecolor leading-tight">
            Bikes Are Not a Sign of Poverty, They Are a Great{" "}
            <span className="text-[#73f59b]"> Equalizer</span>
          </h1>
        </div>
        <div>
          <p className=" text-[1.3rem] leading-relaxed font-opensans font-semibold text-[#CAD1CE]">
