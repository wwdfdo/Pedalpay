...
const RidingMode = () => {
  return (
    <div id="RidingMode" className="py-28 bg-[#283259] drop-shadow-2xl">
      ...
      <div className="w-4/5 flex lg:flex-row flex-col justify-center gap-8 mx-auto">
        {ridingModesArray.map((mode) => (
          <div className=" text-white rounded-lg w-full p-10 transition font-mono ease-in-out delay-150 bg-[#73f59b21] hover:-translate-y-1 hover:scale-105">
